...
import org.tensorflow.model.examples.mnist.data.ImageBatchIterator;
...
public class FashionMnistDataset {
    ...
    public static final int TYPE_UBYTE = 0x08;

    public static final int NUM_CLASSES = 10;

    public static FashionMnistDataset create(int validationSize) {
        try {
            ...
            return new FashionMnistDataset(trainingImages, trainingLabels, null, null, testImages, testLabels);
    ...
    private static ByteNdArray readArchive(String archiveName) throws IOException {
        DataInputStream archiveStream = new DataInputStream(
                new GZIPInputStream(FashionMnistDataset.class.getClassLoader().getResourceAsStream(archiveName))
        );
